...
function createCash() {
  ...
  cash.scale=0.12;
  cash.velocityY = Math.round(random(7,10));
  cash.lifetime = 150;
  cashG.add(cash);
  }
}
...
function createDiamonds() {
  ...
  diamonds.scale=0.03;
  diamonds.velocityY = Math.round(random(7,10));
...
function createjewelry() {
  ...
  jewelry.scale=0.13;
  jewelry.velocityY = Math.round(random(7,10));
...
function createSword(){
  ...
  sword.scale=0.1;
  sword.velocityY = Math.round(random(7,10));
  sword.lifetime = 150;
